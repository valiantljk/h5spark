...
spark-submit --master $SPARKURL --executor-cores 30 --driver-memory 120G --executor-memory 100G --class org.apache.spark.mllib.linalg.distributed.netCDFTest --conf spark.eventLog.enabled=true --conf spark.eventLog.dir=$SCRATCH/spark/spark_event_logs ./tests/read_tests-app.py /global/homes/j/jialin/spark-io/h5spark/python/tests/resources/hdf5/filelist40000 1 1000
